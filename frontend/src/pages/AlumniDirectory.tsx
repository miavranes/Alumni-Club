  ...
  return (
    ...
    >
      ...
      <div className="mb-3 md:mb-4">
        <h5 className="text-md font-semibold md:text-lg text-white">
          {member.name}
        </h5>
        <h6 className="md:text-md text-white">{member.jobTitle}</h6>
      </div>
      {member.description && (
        <p className="text-white text-sm opacity-90 break-all">
          {member.description}
        </p>
      )}
...
>>>>>>> 7085e605405945ce4b0bd5fab9c54c1107a7cf8f
    ...
    `}</style>
      ...
      <section
        id="relume"
        className="px-[5%] py-16 md:py-24 lg:py-28 bg-[#294a70] min-h-screen"
      >
        <div className="container">
          <div
